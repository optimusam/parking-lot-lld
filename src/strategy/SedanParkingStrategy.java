...
public class SedanParkingStrategy extends ParkingStrategy {
    @Override
    public ParkingSpot park(ParkingLot parkingLot, Car car) throws ParkingLotException {
        ...
        ParkingSpot parkingSpotAvailable = ParkingUtils.findRegularParkingSpot(parkingSpots);
        if(parkingSpotAvailable == null) parkingSpotAvailable = ParkingUtils.findSUVParkingSpot(parkingSpots);
        if(parkingSpotAvailable == null) parkingSpotAvailable = ParkingUtils.findEVParkingSpot(parkingSpots);
